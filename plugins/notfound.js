...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  let arrayMenu = ['all', 'game', 'xp', 'stiker', 'kerangajaib', 'quotes', 'grup', 'premium', 'internet', 'anonymous', 'anime', 'nulis', 'downloader', 'tools', 'fun', 'database', 'islamic', 'audio', 'nsfw', 'info', 'tanpakategori', 'owner', 'soon']
     ...
     let judul = `${global.ucapan}, ${name}`.trim()
      const sections = [
      {
        ...
        rows: [
          ...
          { title: 'Coming Soon', 
           "description": "Menu Yang Akan Datang",
      ...
      const listMessage = {
      text: 'Fitur itu tidak tersedia.',
      footer: "Silahkan Klik Tombol Dibawah Ya Untuk Lihat Fitur Bot Yang Tersedia!",
      mentions: await conn.parseMention(judul),
      title: judul,
      buttonText: "Jangan salah tulis lagi yaa🗿",
      sections
    }
...
handler.tags = ['main']
handler.command = ['cepmek', 'many', 'helpe', 'helep']
handler.owner = false
handler.mods = false
